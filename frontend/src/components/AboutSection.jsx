          ...
          <div className="space-y-12" data-aos="fade-right" data-aos-duration="1200">
            ...
            >
              <div className="flex items-start mb-6">
                <div className="bg-red-800 p-4 rounded-xl mr-5 transition-all duration-500 group-hover:rotate-12 group-hover:scale-110">
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="text-center p-4 bg-[#f8f9fa] rounded-xl transition-all duration-500 hover:bg-red-800 hover:text-white group/stat transform hover:scale-105"
                    data-aos="zoom-in"
